...
# Script to calculate expected output for all sites under a design configuration
# Version 0.1
# Author: neyring
...
# Parameters #
# global directory of historic .csv generation profiles (without leap days):
inputDirP1 = "D:\\00_Results\\02_Generation Profiles\\Case 5 - 30 to 65 deg winter opt\\Site "
inputDirP2 = " - Historic Profiles wo leap"
...
resultTitleSuffix = " - 30 to 65 deg winter opt"

for j in range(1, 83):
    inputDirectory = inputDirP1 + str(j) + inputDirP2
    resultGroupTitle = "Site " + str(j) + resultTitleSuffix
